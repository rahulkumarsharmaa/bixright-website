...
export default function PrivacyPolicyPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-light text-brand py-12 px-4 sm:px-6 font-sans">
      <title>{siteData.siteName ? `${siteData.siteName} | Privacy Policy` : "Bixright | Privacy Policy"}</title>
      <meta name="description" content={`Read ${siteData.siteName || "Bixright"}'s privacy policy. Learn how we collect, use, protect, and handle your personal information in accordance with our web services.`} />
      <meta property="og:title" content={siteData.siteName ? `${siteData.siteName} | Privacy Policy` : "Bixright | Privacy Policy"} />
      <meta property="og:description" content={`Read ${siteData.siteName || "Bixright"}'s privacy policy. Learn how we collect, use, protect, and handle your personal information in accordance with our web services.`} />
      ...
      <div className="max-w-4xl mx-auto bg-white border border-brand/10 rounded-3xl p-6 md:p-10 shadow-sm">
        ...
        <div className="space-y-8 text-brand/80 leading-relaxed text-[15px] sm:text-base">
          <section>
            <h2 className="text-xl font-bold text-brand mb-2">1. Overview</h2>
            <p>
          ...
          <section>
            ...
            <p className="mt-2 font-semibold">We never sell or rent your data to anyone.</p>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand mb-2">6. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand mb-2">9. Third-Party Links</h2>
            <p>
