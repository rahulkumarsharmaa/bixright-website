...
export default function FlashDeals() {
  ...
  return (
    <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-2xl md:rounded-4xl p-4 md:p-8 border border-red-100/80">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
        <div className="flex items-center gap-3">
          <div className="bg-red-500 p-2 rounded-full text-white animate-pulse shrink-0">
            <Zap size={20} fill="currentColor" className="md:w-6 md:h-6" />
          </div>
          <div>
            <h2 className="text-lg md:text-2xl font-bold text-gray-900">Flash Deals</h2>
            <p className="text-red-600 font-semibold capitalize text-xs md:text-sm">Save big on the latest audio gear. Shop Best Earbuds and Headphones</p>
          </div>
        </div>
      </div>
